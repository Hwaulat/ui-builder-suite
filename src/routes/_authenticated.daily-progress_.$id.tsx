...
import { Eye, ChevronLeft, Check, Loader2 } from "lucide-react";
  ...
  return (
    <div className="flex-1 flex flex-col space-y-4 p-4 lg:p-6 bg-[#f8fafc] h-full overflow-y-auto">
      ...
      <Card className="flex-1 flex flex-col shadow-sm border-gray-100 rounded-xl bg-white p-6 gap-4">
        ...
        {/* Stepper Status */}
        <div className="flex items-start justify-center max-w-2xl mx-auto w-full pt-4 relative">
          {/* Connecting Line */}
          <div className="absolute top-5 left-[15%] right-[15%] h-[2px] bg-gray-100 -z-10"></div>
          
          {/* Step 1: Inspection */}
          <div className="flex flex-col items-center flex-1">
            <div className="w-10 h-10 rounded-full bg-green-400 flex items-center justify-center text-white ring-4 ring-white mb-3">
              <Check className="w-5 h-5" />
            </div>
            <div className="text-center">
              <p className="text-sm text-gray-500 mb-0.5">Inspection</p>
              <p className="text-sm font-semibold text-gray-900">by Andre Waulat | 24/06/2026</p>
            </div>
          </div>
          
          {/* Step 2: Checked */}
          <div className="flex flex-col items-center flex-1">
            <div className="w-10 h-10 rounded-full bg-orange-400 flex items-center justify-center text-white ring-4 ring-white mb-3">
              <Loader2 className="w-5 h-5" />
            </div>
            <div className="text-center">
              <p className="text-sm text-gray-500 mb-0.5">Checked</p>
          ...
          <div className="flex flex-col items-center flex-1">
            ...
            <div className="text-center">
              <p className="text-sm text-gray-500 mb-0.5">Approved</p>
              <p className="text-sm font-semibold text-gray-900">-</p>
            </div>
          </div>
        </div>
