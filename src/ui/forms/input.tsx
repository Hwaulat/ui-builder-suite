  ...
  ({
    ...
    return (
      <div className={cn("flex flex-col gap-2 w-full", containerClassName)}>
        ...
        <div className={cn(
            "flex group items-center gap-3 w-full h-[40px] rounded-lg bg-neutral-3 border border-transparent transition-colors overflow-hidden focus-within:bg-neutral-3 focus-within:border-transparent",
